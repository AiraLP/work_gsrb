...
/*ZDUyZmZYzZlYTc5YzE3ZWYyN2VkYTM1ZGQzZWUxM2JlNDVkYzg=*/$GLOBALS['____2094369097']= array(base64_decode('ZG'.'VmaW5l'));if(!function_exists(__NAMESPACE__.'\\___733897719')){function ___733897719($_273201459){static $_756499028= false; if($_756499028 == false) $_756499028=array(''.'RU5'.'D'.'T0'.'R'.'F','WQ==');return base64_decode($_756499028[$_273201459]);}};class CBXFeatures{ public static function IsFeatureEnabled($_510773457){ return true;} public static function IsFeatureEditable($_510773457){ return true;} public static function SetFeatureEnabled($_510773457, $_1744650934= true){} public static function SaveFeaturesSettings($_2014457495, $_358168290){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_597826759){} public static function ModifyFeaturesSettings($_597826759, $_201173097){} public static function IsFeatureInstalled($_510773457){ return true;}} $GLOBALS['____2094369097'][0](___733897719(0), ___733897719(1));/**/			//Do not remove this
